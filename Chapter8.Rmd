...
Comment by `@_TanHo` - _You can use "All" instead of "" - not sure why it's recalculating continent when evaluated, reactivelog wasn't very helpful on it._

_Also, you can use unique() to get an unnamed list if you don't want the extra label of "country" in the country dropdown, and don't need to "re-label" country if all you want is to populate choices_
:::
