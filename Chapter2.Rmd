...
Answer from <a href="https://twitter.com/mapaulacaldas)">@mapaulacaldas:</a> the app doesn't work because calls to `plot()` take too long to render with data sets with many columns. You can replace `datasets <- "seals"` to see if everything was running OK.
:::
